...
# --- Cấu hình Cố định ---
APP_NAME = settings.APP_NAME #"CICFlowMeter"
MAIN_CLASS = settings.MAIN_CLASS # "cic.cs.unb.ca.ifm.RT_cmd"

DEFAULT_JVM_OPTS_TEMPLATE = "-Djava.library.path={}/lib/native"

MEMORY_OPTS = [settings.MEM_OPTS_MAX, settings.MEM_OPTS_MIN] # ["-Xmx10g", "-Xms512m"]

def get_app_home() -> Path:
    script_path = Path(os.path.realpath(sys.argv[0]))
    app_home = script_path.parent.resolve()
